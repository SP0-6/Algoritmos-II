...
# Coloca la mitad de cada grupo antes y la otra mitad después del primer elemento. 
# Se usa round para la lista resto y se trunca la lista menores debido a que si ambas tuvieran un número impar de elementos y 
# usaramos la misma operación para las dos, el pivote no quedaría al medio.
